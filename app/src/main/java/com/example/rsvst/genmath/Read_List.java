...
public class Read_List extends AppCompatActivity {
...
static ArrayList<String> lessonlisttitle= new ArrayList<>(
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (final String chapter: chapterlisttitle) {
            ...
            final LinearLayout LessonList = new LinearLayout(Read_List.this);
            ...
            for (final String lesson: lessonlisttitle) {
                ...
                LessonCard.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(Read_List.this, Read.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Read_List.this, MainActivity.class);
        startActivity(intent);
    }
}
